package com.example.messages.Ulti;
...
public class TextDrawableForStaticImage extends Drawable {
    ...
    public TextDrawableForStaticImage(Context context) {
        super();
    ...
    public void setTypeface(Typeface tf) {
        if (mTextPaint.getTypeface() != tf) {
            mTextPaint.setTypeface((Typeface) tf);
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (mTextPath == null) {
            ...
            canvas.drawTextOnPath(mText.toString(), (Path) mTextPath, 0, 0, mTextPaint);
        }
