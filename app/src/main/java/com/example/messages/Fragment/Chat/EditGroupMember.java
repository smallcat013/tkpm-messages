...
public class EditGroupMember extends Fragment implements RecyclerViewClickInterface, RecyclerCheckBoxClick
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View root=inflater.inflate(R.layout.fragment_edit_group_member,container,false);
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                if (snapshot.exists() == true) {
                    ...
                    for (DataSnapshot childSnapShot : snapshot.getChildren()) {
                        ...
                        contactAndSeenTime1.SeenTime="";
                        contactAndSeenTime1.Status="";
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firebaseDatabase.getReference().child("GROUP_CHAT").child(GroupKey).child("groupMemberIdList").setValue(contactID);
