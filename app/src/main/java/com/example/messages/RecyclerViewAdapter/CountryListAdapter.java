...
public class CountryListAdapter extends RecyclerView.Adapter<com.example.messages.RecyclerViewAdapter.CountryListAdapter.viewHolder> {
    ...
    @NonNull
    @Override
    public com.example.messages.RecyclerViewAdapter.CountryListAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull com.example.messages.RecyclerViewAdapter.CountryListAdapter.viewHolder holder, int position) {
