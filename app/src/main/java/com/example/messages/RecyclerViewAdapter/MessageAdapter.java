...
public class MessageAdapter extends RecyclerView.Adapter<com.example.messages.RecyclerViewAdapter.MessageAdapter.viewHolder> {
    ...
    @NonNull
    @Override
    public com.example.messages.RecyclerViewAdapter.MessageAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull com.example.messages.RecyclerViewAdapter.MessageAdapter.viewHolder holder, int position) {
